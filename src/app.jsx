	...
	return (
		<div className='App'>
			<div className='login-form'>
				<h2>Login</h2>
				<input type='text' placeholder='enter username' onFocus={(e) => setCurrentlyFocusedInput(e.target)} />
				<input type='password' placeholder='enter password' onFocus={(e) => setCurrentlyFocusedInput(e.target)} />
			</div>
